...
function convertCollectionDocumentsMetadataToSchema(
  collectionDocumentsTypeMetadata: CollectionDocumentFieldsType[]
): TypeMetadata {
  const typeMetadata = {
    type: 'object',
    properties: {},
...
export type { CollectionDocumentFieldsType, JsonSchemaPropertyType, TypeMetadata };

export { getCollectionDocumentsTypeMetadata, convertCollectionDocumentsMetadataToSchema };
