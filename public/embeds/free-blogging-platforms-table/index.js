...
const columns = [
  {
    id: 'platform',
    name: gridjs.html(
      `<div class="tooltip-wrapper"><div>Platforms</div><div class="tooltip"><a href="https://bloggingplatforms.app/blog/best-free-platforms-for-blogging">Free Blogging Platforms</a></div></div>`
    ),
  ...
  Object.keys(features).map((featureKey) => ({
    id: featureKey,
    name: gridjs.html(
      `<div class="tooltip-wrapper"><div>${features[featureKey].label}</div><div class="tooltip">${features[featureKey].tooltip}</div></div>`
    ),
