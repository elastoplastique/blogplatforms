!(function (t, n) {
  ...
  function x(t, n, e) {
    ...
    if (
      (arguments.length > 2 && (u.children = arguments.length > 3 ? c.call(arguments, 2) : e),
        ...
        t.some(function (t) {
          ...
          t.__d &&
            ...
            (u = n.__P) &&
              ((e = []),
              ((r = b({}, o)).__v = o.__v + 1),
              M(u, o, r, n.__n, void 0 !== u.ownerSVGElement, null != o.__h ? [i] : null, e, null == i ? N(o) : i, o.__h),
              R(e, o),
              o.__e != i && C(o)));
        });
  }
  ...
  function L(t, n, e) {
    for (var r, o = t.__k, i = 0; o && i < o.length; i++)
      (r = o[i]) && ((r.__ = t), (n = 'function' == typeof r.type ? L(r, n, e) : A(e, r, r, o, r.__e, n)));
    return n;
  }
  ...
  function j(t, n, e, r, o) {
    ...
    t: if ('style' === n)
      ...
      (i = n !== (n = n.replace(/Capture$/, ''))),
        ...
        t.l || (t.l = {}),
        (t.l[n + i] = e),
        e ? r || t.addEventListener(n, i ? D : H, i) : t.removeEventListener(n, i ? D : H, i);
    ...
    try {
      t: if ('function' == typeof E) {
        if (
          ...
          e.__c
            ...
            : ('prototype' in E && E.prototype.render
                ? (n.__c = c = new E(v, y))
                : ((n.__c = c = new S(v, y)), (c.constructor = E), (c.render = B)),
              g && g.sub(c),
              (c.props = v),
              c.state || (c.state = {}),
              (c.context = y),
          ...
          null != E.getDerivedStateFromProps &&
            (c.__s == c.state && (c.__s = b({}, c.__s)), b(c.__s, E.getDerivedStateFromProps(v, c.__s))),
          (d = c.props),
          (h = c.state),
          p)
        )
        ...
        if (((c.context = y), (c.props = v), (c.__v = n), (c.__P = t), (x = f.__r), (k = 0), 'prototype' in E && E.prototype.render)) {
          for (c.state = c.__s, c.__d = !1, x && x(n), l = c.render(c.props, c.state, c.context), N = 0; N < c._sb.length; N++)
            c.__h.push(c._sb[N]);
          c._sb = [];
        } else
          do {
      ...
      __e: function (t, n, e, r) {
        for (var o, i, u; (n = n.__); )
          if ((o = n.__c) && !o.__)
            try {
              if (
                ((i = o.constructor) && null != i.getDerivedStateFromError && (o.setState(i.getDerivedStateFromError(t)), (u = o.__d)),
    ...
    Rt = /*#__PURE__*/ (function (t) {
      ...
      return (
        ...
        (n.prototype._process = function (t) {
          var n = {};
          return (
            this.props.url && (n.url = this.props.url(t.url, this.props.page, this.props.limit)),
  ...
  function Ft() {
    ...
    yt(function () {
      return (
        e
          ? ((v.current = new Rt({ limit: p, page: y, url: e.url, body: e.body })), t.pipeline.register(v.current))
          : ((v.current = new Mt({ limit: p, page: y })), t.pipeline.register(v.current)),
    ...
    var C = function (t) {
        m && t !== v.current && (b(0), 0 !== v.current.props.page && v.current.setProps({ page: 0 }));
      },
      E = function () {
                ...
                .map(function (n) {
                  return x(
                    'button',
                    {
                      ...
                      className: rt(
                        y === n ? rt(et('currentPage'), t.className.paginationButtonCurrent) : null,
        ...
        (u.adjustWidth = function (t, n, e) {
            ...
            (l = (function (t) {
              ...
              var i = Array.from(n.parentNode.querySelectorAll('thead th')).reduce(function (t, n) {
                ...
                return (
                  ...
                  r((((e = {})[n.getAttribute('data-column-id')] = { minWidth: n.clientWidth }), e), t)
                );
              }, {});
              return (
                (n.className = e),
          ...
          for (
            ...
            (p.columns && p.columns.length > 0) ||
              (!p.width && u
                ? p.id in l && ((p.width = Wt(l[p.id].width)), (p.minWidth = Wt(l[p.id].minWidth)))
      ...
      return (
        (e.handler = function (t) {
          return 'function' == typeof this.options.handle
            ...
            : t.ok
              ? t.json()
              : (Vt.error('Could not fetch data: ' + t.status + ' - ' + t.statusText, !0), null);
        }),
        (e.get = function (t) {
          ...
          for (var n, e, r = [], o = a(t.querySelector('tbody').querySelectorAll('tr')); !(n = o()).done; ) {
            for (var i, u = [], s = a(n.value.querySelectorAll('td')); !(i = s()).done; ) {
              ...
              1 === l.childNodes.length && l.childNodes[0].nodeType === Node.TEXT_NODE
                ? u.push(((e = l.innerHTML), new DOMParser().parseFromString(e, 'text/html').documentElement.textContent))
      ...
      return (
        ...
        (n.fromPartialConfig = function (e) {
          ...
          return (
            ...
            (r.plugin = new $t()),
            r.search && r.plugin.add({ id: 'search', position: t.PluginPosition.Header, component: Dt }),
            r.pagination && r.plugin.add({ id: 'pagination', position: t.PluginPosition.Footer, component: Ft }),
            r.plugins &&
  ...
  function mn() {
    ...
    return x(
      ...
      e === l.Loading &&
        (!n || 0 === n.length) &&
        x(_n, { message: o('loading'), colSpan: i(), className: rt(et('loading'), t.className.loading) }),
      e === l.Rendered &&
        n &&
        0 === n.length &&
        x(_n, { message: o('noRecordsFound'), colSpan: i(), className: rt(et('notfound'), t.className.notfound) }),
  ...
  function wn(t) {
    ...
    return (
      yt(
        function () {
          var t =
            f() || (c === K.ServerSort ? new bn(r({ columns: l ? l.columns : [] }, a.server)) : new vn({ columns: l ? l.columns : [] }));
          return (
  ...
  function Cn() {
    ...
    return (
      ...
      x(
        'table',
        { ref: n, role: 'grid', className: rt(et('table'), t.className.table), style: r({}, t.style.table, { height: t.height }) },
        x(Sn, null),
        x(mn, null)
      )
    );
  ...
  function En() {
    ...
    return (
      ...
      e
        ? x(
            'div',
            { ref: i, className: rt(et('head'), u.className.header), style: r({}, u.style.header) },
  ...
  function In() {
    ...
    return (
      ...
      o
        ? x(
            'div',
            { ref: n, className: rt(et('footer'), u.className.footer), style: r({}, u.style.footer) },
  ...
  var Ln = /*#__PURE__*/ (function (t) {
    function n(n) {
      ...
      return (
        ...
        (e.plugin = void 0),
        (e.config = new pn().assign({ instance: u(e), eventEmitter: u(e) }).update(n)),
    ...
    return (
      ...
      (e.forceRender = function () {
        return (
          (this.config && this.config.container) || Vt.error('Container is empty. Make sure you call render() before forceRender()', !0),
          this.destroy(),
      ...
      (e.render = function (t) {
        return (
          ...
          t.childNodes.length > 0
            ? (Vt.error('The container element ' + t + ' is not empty. Make sure the container is empty and call render() again'), this)
